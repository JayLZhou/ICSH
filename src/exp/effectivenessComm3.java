...
public class effectivenessComm3 {
    ...
    public effectivenessComm3(String graphDataSetPath, String metaPathsPath, String dataSetName) {
...
//        queryMPathList.add(new MetaPath("2-3-0-0-1-1-0-2-2"));
        queryMPathList.add(new MetaPath("2-4-0-0-1-3-0-1-2"));
...
//            Map<double[], Set<Integer>> setMap = improvedAdvanced2Type.computeComm(dataSetName); // for h = 2
            ...
            for (Map.Entry<double[], Set<Integer>> entries : setMap.entrySet()) {
                //1. find query vertex with maximum importance value
        ...
        LogFinal.log(dataSetName + " community diameter " + LogFinal.format(bDiameter) + "\t" + LogFinal.format(eDiameter) + "\n"
                + " community path-sim " + LogFinal.format(bPath) + "\t" + LogFinal.format(ePath) + "\n" +
                " community density " + LogFinal.format(bDensity) + "\t" + LogFinal.format(eDensity) + "\n", 3);
    }
...
//        dataSetList.add("music");
        ...
        for (String dataSetName : dataSetList) {
            ...
            effectivenessComm3 vdTest = new effectivenessComm3(graphDataSetPath, metaPathsPath, dataSetName);
            for (int k : kArry) {
                vdTest.testAll(k);
            }
            LogFinal.log("\n", 3);
