...
public class CommunityMember2 {
    ...
    public CommunityMember2(String graphDataSetPath, String metaPathsPath, String dataSetName) {
...
//        dataSetList.add("music");
        ...
        int[] kArry = new int[]{7,9,11,13,15};
        ...
        for (String dataSetName : dataSetList) {
            ...
            CommunityMember2 vdTest = new CommunityMember2(graphDataSetPath, metaPathsPath, dataSetName);
            for (int k : kArry) {
                vdTest.testAll(k);
            }
            LogFinal.log("\n", 2);
